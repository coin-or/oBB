# -*- coding: utf-8 -*-
#
# oBB documentation build configuration file, created by
...
texinfo_documents = [
  ('index', 'oBB', u'oBB Documentation',
   u'J. M. Fowkes', 'oBB', 'Parallel global optimization of Hessian Lipschitz continuous functions.',
   'Miscellaneous'),
]
